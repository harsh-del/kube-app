...
function showservices() {
    ...
    var ser = "kubectl get svc"
    xhr.open("GET",addr+ser, true);
    xhr.send();
...
function expose_service(){
    ...
    var ser = "kubectl expose deployment "+i+ " --type="+j+ " --port=" + m 
    //document.write(cm);
    xhr.open("GET",addr+ser, true);
    xhr.send();
...
function describe_service(){
    ...
    var xhr= new XMLHttpRequest();
    var ser= "kubectl describe svc "+ j
    //document.write(ser);
    xhr.open("GET",addr+ser, true);
    xhr.send();
