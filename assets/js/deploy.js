...
function showdeploy() {
    ...
    var dp = "kubectl get deploy"
    xhr.open("GET",addr+dp, true);
    xhr.send();
...
function create_deploy(){
    ...
    var dp = "kubectl  create deployment " +j+ " --image="+i
    //document.write(cm);
    xhr.open("GET",addr+dp, true);
    xhr.send();
...
function describe_deploy(){
    var j = document.getElementById("dn1").value
    var xhr= new XMLHttpRequest();
    var dp = "kubectl describe deploy "+ j
    xhr.open("GET",addr+dp, true);
    xhr.send();
...
function del_deploy(){
    var j = document.getElementById("dn1").value
    var xhr= new XMLHttpRequest();
    var dp = "kubectl delete deploy "+j
    var xhr= new XMLHttpRequest();
    xhr.open("GET",addr+dp, true);
    xhr.send();
